...
- Mappers novos: 13 (CPROM), 79/113 (NINA-03/06), 118/119 (TxSROM/TQROM), 232 (Camerica Quattro) — 24 no total. `examples/sweep` varre uma pasta de ROMs; nos 857 títulos dos EUA de um pack: 97 % com imagem, 14 sem mapper (64, 68, 65, 15, 41, 47, 105, 228…), 2 dumps ruins que executam lixo.

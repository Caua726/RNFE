...
pub const TESTS: &[TestRom] = &[
    ...
    t("cpu_dummy", "cpu_dummy_writes/cpu_dummy_writes_ppumem.nes", "cpu", Mem, Pass, 2000),
    t("cpu_exec_space", "cpu_exec_space/test_cpu_exec_space_ppuio.nes", "bus", Mem, Pass, 2000),
    ...
    t("ppu_vbl_nmi", "ppu_vbl_nmi/rom_singles/02-vbl_set_time.nes", "ppu", Mem, Pass, 2000),
    ...
    t("ppu_vbl_nmi", "ppu_vbl_nmi/rom_singles/06-suppression.nes", "ppu", Mem, Pass, 2000),
    ...
    t("ppu_vbl_nmi", "ppu_vbl_nmi/rom_singles/10-even_odd_timing.nes", "ppu", Mem, Pass, 2000),
    t("vbl_nmi_timing", "vbl_nmi_timing/1.frame_basics.nes", "ppu", Screen, Pass, 1200),
    t("vbl_nmi_timing", "vbl_nmi_timing/2.vbl_timing.nes", "ppu", Screen, Pass, 1200),
    t("vbl_nmi_timing", "vbl_nmi_timing/3.even_odd_frames.nes", "ppu", Screen, Pass, 1200),
    t("vbl_nmi_timing", "vbl_nmi_timing/4.vbl_clear_timing.nes", "ppu", Screen, Pass, 1200),
    t("vbl_nmi_timing", "vbl_nmi_timing/5.nmi_suppression.nes", "ppu", Screen, Pass, 1200),
    ...
    t("sprite_hit", "sprite_hit_tests_2005.10.05/02.alignment.nes", "ppu", Screen, Pass, 600),
    t("sprite_hit", "sprite_hit_tests_2005.10.05/03.corners.nes", "ppu", Screen, Pass, 600),
    t("sprite_hit", "sprite_hit_tests_2005.10.05/04.flip.nes", "ppu", Screen, Pass, 600),
    t("sprite_hit", "sprite_hit_tests_2005.10.05/05.left_clip.nes", "ppu", Screen, Pass, 600),
    t("sprite_hit", "sprite_hit_tests_2005.10.05/06.right_edge.nes", "ppu", Screen, Pass, 600),
    t("sprite_hit", "sprite_hit_tests_2005.10.05/07.screen_bottom.nes", "ppu", Screen, Pass, 600),
    ...
    t("sprite_hit", "sprite_hit_tests_2005.10.05/11.edge_timing.nes", "ppu", Screen, Pass, 600),
    t("sprite_overflow", "sprite_overflow_tests/1.Basics.nes", "ppu", Screen, Pass, 600),
    t("sprite_overflow", "sprite_overflow_tests/2.Details.nes", "ppu", Screen, Pass, 600),
    t("sprite_overflow", "sprite_overflow_tests/3.Timing.nes", "ppu", Screen, Pass, 600),
    t("sprite_overflow", "sprite_overflow_tests/4.Obscure.nes", "ppu", Screen, Pass, 600),
    t("sprite_overflow", "sprite_overflow_tests/5.Emulator.nes", "ppu", Screen, Pass, 600),
    t("oam", "oam_read/oam_read.nes", "ppu", Mem, Pass, 2000),
    t("oam", "oam_stress/oam_stress.nes", "ppu", Mem, Pass, 4000),
    t("ppu_misc", "ppu_open_bus/ppu_open_bus.nes", "ppu", Mem, Pass, 2000),
    t("ppu_misc", "ppu_read_buffer/test_ppu_read_buffer.nes", "ppu", Mem, Pass, 4000),
    // ---------------------------------------------------------------- APU

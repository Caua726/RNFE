...
pub const TESTS: &[TestRom] = &[
    ...
    t(
        ...
        "cpu",
        Mem,
        KF("opcodes não-oficiais ANC/ALR/ARR/AXS/SHX/SHY (F1-02)"),
        2000,
    ),
    ...
    t(
        ...
        "cpu",
        Mem,
        KF("BRK: I setado antes do push, B nunca limpo (F1-03)"),
        2000,
    ),
    ...
    t(
        ...
        "cpu",
        Mem,
        KF("opcodes não-oficiais e dummy reads (F1-01/F1-06)"),
        4000,
    ),
    ...
    t(
        ...
        "bus",
        Mem,
        KF("open bus em $4000-$4017 (F2-02)"),
        2000,
    ),
    ...
    t(
        ...
        "apu",
        Mem,
        KF("frame counter na metade da velocidade (F2-01)"),
        1000,
    ),
    t(
        "apu_test",
        ...
        "apu",
        Mem,
        KF("sem IRQ do frame counter (F2-01)"),
        1000,
    ),

...
impl Cpu6502 {
    ...
    // NOP: No Operation
    pub fn NOP(&mut self, bus: &mut crate::bus::Bus) -> u8 {
        // NOPs não-oficiais com operando leem o endereço (visível em registradores com efeito colateral)
        self.fetch(bus);
        1
    }
    ...
    pub fn instrucoes() -> Vec<Instruction> {
        vec![
            ...
            Instruction { name: "NOP", operate: Cpu6502::NOP, addrmode: Cpu6502::ABX, cycles: 4 },
            ...
            Instruction { name: "SAX", operate: Cpu6502::SAX, addrmode: Cpu6502::ZPY, cycles: 4 },
            ...
            Instruction { name: "LAX", operate: Cpu6502::LAX, addrmode: Cpu6502::ZPY, cycles: 4 },

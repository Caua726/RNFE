...
Gerado por `cargo run -p rnfe-core --release --bin status` · commit `30305d6`.
...
| ROM | Estilo | Esperado | Resultado | Detalhe |
|---|---|---|---|---|
| `cpu_exec_space/test_cpu_exec_space_ppuio.nes` | $6000 | KnownFail | ❌ | open bus (F2-05) — código 0x03: Failed #3 |
| `cpu_exec_space/test_cpu_exec_space_apu.nes` | $6000 | KnownFail | ❌ | open bus em $4000-$4017 (F2-02) — código 0x02: Failed #2 |
## cpu
...
| `ppu_vbl_nmi/rom_singles/08-nmi_off_timing.nes` | $6000 | KnownFail | ❌ | NMI (F2-04) — código 0x01: Failed |
| `ppu_vbl_nmi/rom_singles/09-even_odd_frames.nes` | $6000 | Pass | ✅ |  |
| `ppu_vbl_nmi/rom_singles/10-even_odd_timing.nes` | $6000 | KnownFail | ❌ | odd frame (F2-04) — código 0x03: Failed #3 |
...
| `sprite_hit_tests_2005.10.05/04.flip.nes` | tela | KnownFail | ❌ | a verificar — FAILED #2 |
| `sprite_hit_tests_2005.10.05/05.left_clip.nes` | tela | KnownFail | ❌ | a verificar — FAILED #5 |
| `sprite_hit_tests_2005.10.05/06.right_edge.nes` | tela | KnownFail | ❌ | x=255 (F2-06) — FAILED #2 |
| `sprite_hit_tests_2005.10.05/07.screen_bottom.nes` | tela | KnownFail | ❌ | a verificar — FAILED #4 |
...
| `sprite_hit_tests_2005.10.05/11.edge_timing.nes` | tela | KnownFail | ❌ | x=255 (F2-06) — FAILED #3 |
| `sprite_overflow_tests/1.Basics.nes` | tela | KnownFail | ❌ | overflow no 8º sprite, não no 9º (F2-06) — FAILED: #6 |
| `sprite_overflow_tests/2.Details.nes` | tela | KnownFail | ❌ | avaliação de sprites (F2-06) — FAILED: #9 |
| `sprite_overflow_tests/3.Timing.nes` | tela | KnownFail | ❌ | avaliação de sprites (F2-06) — FAILED: #5 |
| `sprite_overflow_tests/4.Obscure.nes` | tela | KnownFail | ❌ | avaliação de sprites (F2-06) — FAILED: #7 |
| `sprite_overflow_tests/5.Emulator.nes` | tela | KnownFail | ❌ | avaliação de sprites (F2-06) — FAILED: #3 |
| `oam_read/oam_read.nes` | $6000 | Pass | ✅ |  |
| `oam_stress/oam_stress.nes` | $6000 | KnownFail | ❌ | a verificar — código 0x01: Failed |
| `ppu_open_bus/ppu_open_bus.nes` | $6000 | KnownFail | ❌ | sem open bus (F2-05) — código 0x02: Failed #2 |
| `ppu_read_buffer/test_ppu_read_buffer.nes` | $6000 | KnownFail | ❌ | a verificar — 4000 frames sem veredito; última linha:  |
## apu

| ROM | Estilo | Esperado | Resultado | Detalhe |
|---|---|---|---|---|
| `apu_test/rom_singles/1-len_ctr.nes` | $6000 | Pass | ✅ |  |
| `apu_test/rom_singles/2-len_table.nes` | $6000 | KnownFail | ❌ | frame counter na metade da velocidade (F2-01) — código 0x01: Failed |
| `apu_test/rom_singles/3-irq_flag.nes` | $6000 | KnownFail | ❌ | sem IRQ do frame counter (F2-01) — código 0x04: Failed #4 |
| `apu_test/rom_singles/4-jitter.nes` | $6000 | KnownFail | ❌ | frame counter (F2-01) — código 0x03: Failed #3 |
| `apu_test/rom_singles/5-len_timing.nes` | $6000 | KnownFail | ❌ | frame counter (F2-01) — código 0x02: Failed #2 |
| `apu_test/rom_singles/6-irq_flag_timing.nes` | $6000 | KnownFail | ❌ | frame counter (F2-01) — código 0x03: Failed #3 |
| `apu_test/rom_singles/7-dmc_basics.nes` | $6000 | KnownFail | ❌ | DMC (F2-02) — código 0x02: Failed #2 |
| `apu_test/rom_singles/8-dmc_rates.nes` | $6000 | KnownFail | ❌ | DMC (F2-02) — código 0x03: Failed #3 |
| `blargg_apu_2005.07.30/01.len_ctr.nes` | tela | Pass | ✅ |  |
| `blargg_apu_2005.07.30/02.len_table.nes` | tela | KnownFail | ❌ | frame counter (F2-01) — código $40: $40 |
| `blargg_apu_2005.07.30/03.irq_flag.nes` | tela | KnownFail | ❌ | IRQ (F2-01) — código $04: $04 |
| `blargg_apu_2005.07.30/04.clock_jitter.nes` | tela | KnownFail | ❌ | frame counter (F2-01) — código $00: $0 |
| `blargg_apu_2005.07.30/05.len_timing_mode0.nes` | tela | KnownFail | ❌ | frame counter (F2-01) — código $00: $0 |
| `blargg_apu_2005.07.30/06.len_timing_mode1.nes` | tela | KnownFail | ❌ | frame counter (F2-01) — código $00: $0 |
| `blargg_apu_2005.07.30/07.irq_flag_timing.nes` | tela | KnownFail | ❌ | IRQ (F2-01) — código $03: $03 |
| `blargg_apu_2005.07.30/08.irq_timing.nes` | tela | KnownFail | ❌ | IRQ (F2-01) — código $04: $04 |
| `blargg_apu_2005.07.30/09.reset_timing.nes` | tela | KnownFail | ❌ | reset do divisor (F2-01) — código $04: $04 |
| `blargg_apu_2005.07.30/10.len_halt_timing.nes` | tela | KnownFail | ❌ | halt/reload (F2-03) — código $00: $0 |
| `blargg_apu_2005.07.30/11.len_reload_timing.nes` | tela | KnownFail | ❌ | halt/reload (F2-03) — código $00: $0 |
| `apu_reset/4015_cleared.nes` | $6000 | Pass | ✅ |  |
| `apu_reset/4017_timing.nes` | $6000 | KnownFail | ❌ | $4017 (F2-01) — código 0x03: Failed #3 |
| `apu_reset/4017_written.nes` | $6000 | KnownFail | ❌ | $4017 (F2-01) — código 0x02: Failed #2 |
| `apu_reset/irq_flag_cleared.nes` | $6000 | Pass | ✅ |  |
| `apu_reset/len_ctrs_enabled.nes` | $6000 | KnownFail | ❌ | a verificar — código 0x03: Failed #3 |
| `apu_reset/works_immediately.nes` | $6000 | KnownFail | ❌ | a verificar — código 0x02: Failed #2 |
| `dmc_dma_during_read4/dma_2007_read.nes` | $6000 | KnownFail | ❌ | DMC sem stall (F2-02) — 1200 frames sem veredito; última linha:  |
| `dmc_dma_during_read4/dma_2007_write.nes` | $6000 | KnownFail | ❌ | DMC sem stall (F2-02) — 1200 frames sem veredito; última linha:  |
| `dmc_dma_during_read4/dma_4016_read.nes` | $6000 | KnownFail | ❌ | DMC sem stall (F2-02) — 1200 frames sem veredito; última linha:  |
| `dmc_dma_during_read4/double_2007_read.nes` | $6000 | KnownFail | ❌ | DMC sem stall (F2-02) — 1200 frames sem veredito; última linha:  |
| `dmc_dma_during_read4/read_write_2007.nes` | $6000 | KnownFail | ❌ | DMC sem stall (F2-02) — 1200 frames sem veredito; última linha:  |
| `dmc_tests/buffer_retained.nes` | $6000 | KnownFail | ❌ | DMC (F2-02) — 1200 frames sem veredito; última linha:  |
| `dmc_tests/latency.nes` | $6000 | KnownFail | ❌ | DMC (F2-02) — 1200 frames sem veredito; última linha:  |
| `dmc_tests/status.nes` | $6000 | KnownFail | ❌ | DMC (F2-02) — 1200 frames sem veredito; última linha:  |
| `dmc_tests/status_irq.nes` | $6000 | KnownFail | ❌ | DMC IRQ (F2-02) — 1200 frames sem veredito; última linha:  |
## mapper
